...
class ImageByFolderMobileNet(nn.Module):
	def __init__(self):
		super(ImageByFolderMobileNet, self).__init__()
		self.mobilenet = nn.Sequential(mobilenet_v3_large(),)
		self.flatten = nn.Flatten()
		self.linear0 = nn.Linear(1000,CFG.num_classes)
		self.relu = nn.ReLU()

		_layers = []
		_layers.append(self.mobilenet)
