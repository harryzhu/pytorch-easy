...
class ImageByFolderGoogLeNet(nn.Module):
	def __init__(self):
		super(ImageByFolderGoogLeNet, self).__init__()
		self.googlenet = nn.Sequential(GoogLeNet(),)
		self.flatten = nn.Flatten()
		self.linear0 = nn.Linear(1000,CFG.num_classes)
		self.relu = nn.ReLU()

		_layers = []
		_layers.append(self.googlenet)
